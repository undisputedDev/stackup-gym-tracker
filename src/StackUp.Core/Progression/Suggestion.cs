...
/// <param name="IsDeload">True when the weight is a deload reset (after repeated downs) instead of a plain decrement.</param>
public sealed record Suggestion(double? WeightKg, int? TargetReps, int SetCount, bool IsDeload = false);
